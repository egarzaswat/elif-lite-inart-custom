...
class Elif_Recent_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_attr__( 'Themient: Recent Posts', 'elif-lite' ),
			array( 'description' => esc_attr__( 'Display the most recent posts from all categories.', 'elif-lite' ) )
		);
	}
 	...
 	public function form( $instance ) {
		...
		$title = isset( $instance[ 'title' ] ) ? sanitize_text_field( $instance[ 'title' ] ) : esc_attr__( 'Recent Posts', 'elif-lite' );
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id( 'qty' ); ?>" name="<?php echo $this->get_field_name( 'qty' ); ?>" type="number" min="1" max="10" step="1" value="<?php echo absint( $qty ); ?>" />
		</p>
	...
	public function widget( $args, $instance ) {
		extract( $args );
        $comments = null; $date = null; $qty = null; $show_thumb = null; $display_type = null;
